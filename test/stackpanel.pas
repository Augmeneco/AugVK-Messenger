...
uses
  ...
  DelphiCompatibility, LResources;
...
begin
  ...
  RegisterComponents('AugControls',[TStackPanel]);
end;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          ////Bounds := ControlInfo.Control.BoundsRect;
          Bounds.Width := Control.Parent.Width;//Control.BorderSpacing.ControlWidth;//Size.cx;
          Bounds.Height := Control.BorderSpacing.ControlHeight;//Size.cy;
